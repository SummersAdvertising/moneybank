...
role :app, %w{deploy@summers.com.tw}
role :web, %w{deploy@summers.com.tw}
role :db,  %w{deploy@summers.com.tw}
...
server 'summers.com.tw', user: 'deploy', password: '2wsx3edc', roles: %w{web app}, my_property: :my_value
